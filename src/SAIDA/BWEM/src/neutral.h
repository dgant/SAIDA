...
namespace BWEM {
	...
	public:
		...
		virtual Ressource 				*IsRessource()				{
			return nullptr;
		}
		virtual const Ressource 		*IsRessource() const			{
			return nullptr;
		}

		// If this Neutral is a Mineral, returns a typed pointer to this Mineral.
		// Otherwise, returns nullptr.
		virtual Mineral 				*IsMineral()					{
			return nullptr;
		}
		virtual const Mineral 			*IsMineral() const			{
			return nullptr;
		}

		// If this Neutral is a Geyser, returns a typed pointer to this Geyser.
		// Otherwise, returns nullptr.
		virtual Geyser 				*IsGeyser()					{
			return nullptr;
		}
		virtual const Geyser 			*IsGeyser() const			{
			return nullptr;
		}

		// If this Neutral is a StaticBuilding, returns a typed pointer to this StaticBuilding.
		// Otherwise, returns nullptr.
		virtual StaticBuilding 		*IsStaticBuilding()			{
			return nullptr;
		}
		virtual const StaticBuilding 	*IsStaticBuilding() const	{
			return nullptr;
		}

		// Returns the BWAPI::Unit this Neutral is wrapping around.
		BWAPI::Unit						Unit() const				{
			return m_bwapiUnit;
		}
		...
		BWAPI::TilePosition				TopLeft() const				{
			return m_topLeft;
		}
		...
		Neutral 						*LastStacked()				{
			...
			while (pTop->m_pNextStacked) pTop = pTop->m_pNextStacked;
	...
	public:
		...
		Ressource 				*IsRessource() override		{
			return this;
		}
		const Ressource 		*IsRessource() const override {
			return this;
		}

		// Returns the initial amount of ressources for this Ressource (same as Unit()->getInitialResources).
		int						InitialAmount() const		{
	...
	public:
		...
		Mineral 				*IsMineral() override		{
			return this;
		}
		const Mineral 			*IsMineral() const override	{
			return this;
		}
	...
	public:
		...
		Geyser 				*IsGeyser() override			{
			return this;
		}
		const Geyser 			*IsGeyser() const override	{
			return this;
		}
	...
	public:
		...
		StaticBuilding 		*IsStaticBuilding() override			{
			return this;
		}
		const StaticBuilding 	*IsStaticBuilding() const override	{
			return this;
		}
