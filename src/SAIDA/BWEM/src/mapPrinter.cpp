...
namespace BWEM {
	...
	namespace utils {
		...
		string MapPrinter::m_fileName = "C:/StarCraft/bwapi-data/BWEM_map/";
		...
		void MapPrinter::Initialize(const Map *pMap)
		{
			...
			m_fileName += BWAPI::Broodwar->mapFileName().c_str();
			ReplaceString(m_fileName, ".scx", ".bmp");
			ReplaceString(m_fileName, ".scm", ".bmp");
