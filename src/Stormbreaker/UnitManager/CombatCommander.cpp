...
void CombatCommander::update()
{
	...
	try
	{
	//	vector<UnitInfo*> comsatStationList = INFO.getBuildings(Terran_Comsat_Station, S);
...
bool CombatCommander::inDetectedArea(Unit targetUnit)
{
	return inDetectedArea(targetUnit->getType(), targetUnit->getPosition());
}

bool CombatCommander::inDetectedArea(UnitType targetType, Position targetPosition)
{
	bool isExist = false;
...
bool CombatCommander::inTheScanArea(Position targetPosition)
{
	bool isExist = false;
	/*
...
bool CombatCommander::isReservedPosition(Position targetPosition)
{
	bool isExist = false;
...
bool CombatCommander::checkScan(Unit targetUnit)
{
...
bool CombatCommander::inArea(Position targetPosition, Position centerPosition, int range)
{
...
bool CombatCommander::useScan(Position targetPosition)
{
//	uList scanList = INFO.getUnits(Spell_Scanner_Sweep, S);
	bool isExist = false;
...
void CombatCommander::updateReserveScanList()
{
	//uList scanList = INFO.getUnits(Spell_Scanner_Sweep, S);
